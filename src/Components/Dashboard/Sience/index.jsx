...
import { CREATE_SCIENCE_BOOK } from '../../../Graphql/Mutation/'
...
export default function Sience() {
    ...
    const [scienceBook, { data, loading, error }] = useMutation(CREATE_SCIENCE_BOOK)
        ...
        if (enterence.title) {
            scienceBook({
                variables: {
                    ...
                    author: enterence.author,
                    degree: enterence.degree,
